                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                            ...
                            <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                                ...
                                <div>
                                    <InputLabel htmlFor="task_name" value="Project Name" className="text-white" />
                                ...
                                <div>
                                    <InputLabel htmlFor="task_description" value="Project Description" className="text-white" />
                                ...
                                <div>
                                    <InputLabel htmlFor="task_priority" value="Status" className="text-white" />
