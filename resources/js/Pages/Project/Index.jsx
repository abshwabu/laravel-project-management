...
export default function Index({auth, projects, queryParams = null, success}) {
    ...
    return (
        ...
        <div className="flex items-center justify-between">
            ...
            <Link href={route('project.create')} className="bg-emerald-500 py-1 px-3 text-white rounded shadow transiton-all hover:bg-emerald-600">Add New</Link>
        </div>
    }
        >
            <Head title="Projects"/>
                                ...
                                <tbody>
                                    {projects.data.map((project) => (
                                        ...
                                        <td className="px-3 py-3 text-nowrap text-right">
                                            ...
                                            <button onClick={(e) => deleteProjuct(project)} className="font-medium text-red-600 dark:text-red-500 hover:underline mx-1">Delete</button>
                                        </td>
                                    </tr>
                                    ))}
                                </tbody>
